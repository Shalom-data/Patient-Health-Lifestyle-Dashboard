...
4. [Key Pages in This Report](#key-pages-in-this-report)
   ...
   - [Page 2 → Organ Damage Risk Drivers](#page-2--organ-damage-risk-drivers)
   - [Page 3 → Key Influencers & Risk Factor Combinations](#page-3--key-influencers--risk-factor-combinations)
